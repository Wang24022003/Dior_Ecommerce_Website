    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h7 class="text-themecolor">Review List</h7>
                <ol class="breadcrumb">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="button-container">
                                                <a class="edit-button" href="edit_review?id=${review.reviewId}">
                                                ...
                                                <button class="delete-button" type="button" onclick="delete_review(${review.reviewId})">
