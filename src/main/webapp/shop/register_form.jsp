            ...
            <div class="container_sign">
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        <h11 class="form-title1">Sign up</h11>

                        <form method="post" action="register_customer" class="register-form1" id="customerForm">
                            ...
                            <div class="form-group">
                                <input type="checkbox" name="agree-term" id="agree-term"
                                       class="agree-term"/> <label for="agree-term"
                                            class="label-agree-term" style="color:white;"><span><span></span></span>
                    ...
                    <div class="signup-image">
                        <figure>
                            <img src="http://localhost:8080/eCommerceWebsite/shop/images/logoDior.png" alt="sing up image">
                        </figure>
                        <button class="ghost1" id="register">
                            <a href="login" class="signup-image-link" style="color: white;">I am already member</a>
