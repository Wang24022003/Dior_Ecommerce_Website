    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="mt-4"><img src="http://localhost:8080/eCommerceWebsite/shop/images/logo-store.jpg" class="img-circle"
                                                  width="150"/>
                            <h4 class="card-title mt-2">Dior Store</h4>
                        </center>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" class="ui-btn">Save</button>
                                       &nbsp;&nbsp;&nbsp;
                                        <button type="button" onclick="history.go(-1);" class="ui-btn1">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
