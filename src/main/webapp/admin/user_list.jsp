...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h7 class="text-themecolor">User List</h7>
                <ol class="breadcrumb">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="button-container">
                                                <a class="edit-button" href="edit_user?id=${user.userId}">
                                                ...
                                                <button class="delete-button" type="button" onclick="delete_user(${user.userId})">
    ...
    <!-- footer -->
    <!-- ============================================================== -->
    <footer class="footer"> © 2023 AdminDior by <a href="https://www.wrappixel.com/">Dior.com</a></footer>
    <!-- ============================================================== -->
    <!-- End footer -->
    <!-- ============================================================== -->
</div>
