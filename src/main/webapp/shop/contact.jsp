...
<section class="contact">
    <div class="container">
        <div class="row contact-details">
            <div class="col-sm-8 text-center text-md-left shadow p-3 mb-5 bg-white rounded">
            ...
            <div class="col-sm-4 mb-5 text-center text-md-left mx-auto shadow p-3 mb-5 bg-white rounded">
                <h3>Contact</h3>
