    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h7 class="text-themecolor">Customer List</h7>
                <ol class="breadcrumb">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="button-container">
                                                <a class="edit-button" href="edit_customer?id=${customer.customerId}">
                                                ...
                                                <button class="delete-button" type="button" onclick="delete_customer(${customer.customerId})">
